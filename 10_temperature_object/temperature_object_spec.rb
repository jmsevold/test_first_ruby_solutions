...
#
# Remember to define the `from_celsius` factory method as a *class* method, 
#not an *instance* method.
#
# The temperature object's constructor should 
#accept an *options hash* which contains either a `:celcius` entry or a `:fahrenheit` entry.
#
#
#
